...
1. Infraestructura: Docker Registry local, K3s Control Plane.
1. Core Spring: Config Server, Discovery Server (Eureka).

1. Microservicios de Negocio: Customers, Vets, Visits, GenAI.

1. Gateway: API Gateway (Punto de entrada único en puerto 80).

1. Monitoreo: Grafana (Visualización), Prometheus (Métricas).
